...
const images = [
  { src: img2, caption: "Water systems and natural flow." },
  { src: img3, caption: "Fog, uncertainty, and pattern recognition." },
  { src: img4, caption: "Elevation changes perspective." },
  { src: img5, caption: "Texture, structure, and repetition." },
];
...
export default function Hobbies() {
  ...
  return (
    <section id="hobbies" className="py-6 px-2 max-w-6xl mx-auto relative z-10">
      <div className="grid md:grid-cols-2 gap-10 items-center">
        ...
        <div className="relative">
          ...
          <p className="mt-3 text-sm text-muted">{images[index].caption}</p>
            ...
            {images.map((_, i) => (
              <button
                ...
                className={`w-2.5 h-2.5 rounded-full transition ${
                  i === index ? "bg-primary" : "bg-muted/40 hover:bg-muted"
                }`}
